...
driver.get("https://afppred.anvil.app/")
time.sleep(5)
driver.find_element(By.CLASS_NAME, "fa-cloud-download").click()
driver.find_elements(By.CLASS_NAME, "anvil-panel-section-gutter")[5].click()
driver.find_elements(By.CLASS_NAME, "anvil-panel-section-gutter")[6].click()